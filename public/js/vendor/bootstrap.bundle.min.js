...
!(function(e, t) {
	...
	function Fe(e) {
		...
		return i && 'BODY' !== i && 'HTML' !== i
			? -1 !== [ 'TH', 'TD', 'TABLE' ].indexOf(n.nodeName) && 'static' === ke(n, 'position') ? Fe(n) : n
				...
				return e
					.reduce(function(e, t) {
						return '' === e[e.length - 1] && -1 !== [ '+', '-' ].indexOf(t)
							...
							: i ? ((e[e.length - 1] += t), (i = !1), e) : e.concat(t);
					}, [])
					.map(function(e) {
				...
				computeStyle: {
					...
					fn: function(e, t) {
						...
						if (
							((m =
								'bottom' == u
									? 'HTML' === a.nodeName ? -a.clientHeight + h.bottom : -l.height + h.bottom
									: h.top),
							(p =
								'right' == f
									? 'HTML' === a.nodeName ? -a.clientWidth + h.right : -l.width + h.right
									: h.left),
							s && d)
						)
				...
				(e._getPlacement = function() {
					...
					return (
						e.hasClass(Ht)
							...
							: e.hasClass(Rt)
								? (t = Gt)
								: e.hasClass(Ft) ? (t = $t) : p(this._menu).hasClass(Mt) && (t = Xt),
						t
					);
				}),
					...
					'object' != typeof t || (!t.nodeType && !t.jquery)
						? this.config.html
							? (this.config.sanitize && (t = In(t, this.config.whiteList, this.config.sanitizeFn)),
								e.html(t))
							: e.text(t)
						: this.config.html ? p(t).parent().is(e) || e.empty().append(t) : e.text(p(t).text());
				}),
				(e.getTitle = function() {
				...
				(i._jQueryInterface = function(n) {
					return this.each(function() {
						var e = p(this),
							t = e.data(zi);
						if (
							(t || ((t = new i(this, 'object' == typeof n && n)), e.data(zi, t)), 'string' == typeof n)
						) {
							if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
							t[n](this);
						}
